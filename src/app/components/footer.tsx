    ...
    return (
        <footer className="bg-[#111] text-[#7E7E7E] text-sm pt-10">
            <div className="max-w-7xl mx-auto px-4 grid grid-cols-1 sm:grid-cols-2 md:grid-cols-4 gap-8">
                ...
                <div className="flex flex-col md:items-
                end space-y-5 text-2xl">

                    <div className="flex space-x-4">
                        <Link href="/" className="hover:opacity-75"><FaTwitter /></Link>
                        <Link href="/" className="hover:opacity-75"><FaFacebook /></Link>
                        <Link href="https://www.youtube.com/@n8xeditz561" className="hover:opacity-75"><FaYoutube /></Link>
                        <Link href="/" className="hover:opacity-75"><FaInstagram /></Link>
                    </div>
                </div>
